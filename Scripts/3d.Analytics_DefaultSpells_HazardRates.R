...
(gsurv_ht <- ggplot(datSurv[Time <= maxPeriod, ], aes(x = Time)) +
    ...
    geom_line(aes(y = Hazard_Actual, colour = "Actual", linetype = "Actual")) +
    ...
    scale_colour_manual(
      name = "",
      values = c("Actual" = vCol2[2], "Spline" = "black"),
      breaks = c("Actual", "Spline")
    ) +
    scale_linetype_manual(
      name = "",
      values = c("Actual" = "solid", "Spline" = "dotted"),
      breaks = c("Actual", "Spline")
    ) +
    scale_fill_manual(
      name = "",
...
(gsurv_ft <- ggplot(datSurv[Time <= maxPeriod,], aes(x = Time, y = EventRate)) +
    theme_minimal() +
    geom_point(aes(colour = "Actual"), size = 1, show.legend = FALSE) +
    geom_line(aes(colour = "Actual", linetype = "Actual")) +
    ...
    scale_colour_manual(
      name = "",
      values = c("Actual" = vCol3[2], "Spline" = "black"),
      breaks = c("Actual", "Spline")
    ) +
    scale_linetype_manual(
      name = "",
