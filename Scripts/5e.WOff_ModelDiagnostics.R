...
cat((anyNA(c(datCredit_classic[,prob_LR]))) %?% "WARNING: Missingness detected in predicted probabilities of the Validation Set.\n" %:%
...
# - Cleanup
rm(coefDeter_LR, coefDeter_Adv, coefDeter_LR, PseudoR2_Table)
...
BasAUC_B <- AUC_overTime(datCredit,"DefSpell_Max_Date","DefSpell_Event_Bas_Youden")
