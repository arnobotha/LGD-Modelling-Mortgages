...
# Goodness-of-fit
table_Assess[order(AIC)]
### RESULTS: Best AIC-results: [PrevDefaults]; [g0_Delinq_Num]; [slc_acct_arr_dir_3]; [g0_Delinq_Lag_1]; [slc_acct_arr_dir_Change_Ind]
# Discriminatory power (in-sample)
table_Assess[order(C, decreasing=T)]
...
### RESULTS: AIC: 69893; R^2: 12.62%; RMSE:  19.47%; MAE:  10.05%

# - Stepwise forward selection using BIC
ptm <- proc.time() # for runtime calculations (ignore)
modGLM_step <- stepwise_cpglm_both(modGLM_base, modGLM_full,datCredit_train)
proc.time() - ptm # IGNORE: elapsed runtime; 149m

# - Evaluate model
summary(modGLM_step)
evalLS(modGLM_step,datCredit_train,targetFld="LossRate_Real",modGLM_base)
### RESULTS: AIC: 69891; R^2: 12.61%; RMSE:  19.47%; MAE:  10.05%

### CONCLUSION: Select variables from automated selection procedure:
###               [PrevDefaults]; [g0_Delinq_Any_Aggr_Prop_Lag_5];
###               [g0_Delinq_Num]; [g0_Delinq_SD_5]; [DefSpell_Age];
###               [g0_Delinq_Any_Aggr_Prop_Lag_12]; [DefaultStatus1_Aggr_Prop_Lag_2];
###               [slc_past_due_amt_imputed_med]; [g0_Delinq_Any_Aggr_Prop_Lag_9]; [g0_Delinq_SD_6];
###               [DefaultStatus1_Aggr_Prop_Lag_1]; [ArrearsToBalance_Aggr_Prop]; [g0_Delinq_Ave];
###               [DefaultStatus1_Aggr_Prop]; [g0_Delinq_SD_4]
...
summary(modGLM_full)
evalLS(modGLM_full,datCredit_train,targetFld="LossRate_Real",modGLM_base)
### RESULTS: AIC: 79 618; Pseudo R^2: 1.95%; RMSE: 20.62%; MAE: 11.98%
...
summary(modGLM_step)
evalLS(modGLM_step,datCredit_train,targetFld="LossRate_Real",modGLM_base)
### RESULTS: AIC: 79 619; Pseudo R^2: 1.95%; RMSE: 20.62%; MAE: 11.98%
...
### CONCLUSION: [InterestRate_Margin_Aggr_Med] is not significant, refit model without this variable


# --- 3.3 Model refinements
# - Initialize variables to be tested
vars <- c("DefSpell_Maturity_Aggr_Mean", "AgeToTerm_Aggr_Mean", "NewLoans_Aggr_Prop")
...
### RESULTS: AIC: 79 618; Pseudo R^2: 1.94%; RMSE: 20.62%; MAE: 11.98%

### CONCLUSION: Select variables from automated variable selection procedure:
###             [DefSpell_Maturity_Aggr_Mean]; [AgeToTerm_Aggr_Mean]; [NewLoans_Aggr_Prop]
...
# Goodness-of-fit
table_Assess[order(AIC)]
### RESULTS: Best AIC-results: [InterestRate_Nom]; [pmnt_method_grp]; [BalanceToPrincipal_1]; [Instalment_Real ]; [Principal_Real]
# Discriminatory power (in-sample)
table_Assess[order(C, decreasing=T)]
...
summary(modGLM_step)
evalLS(modGLM_step,datCredit_train,targetFld="LossRate_Real",modGLM_base)
### RESULTS: AIC: 79 665; R^2: 2.06%; RMSE: 20.70%; MAE: 11.97%
...
# - Initialize variables to be tested
vars <- c("M_DTI_Growth_12", "M_DTI_Growth_9",
          "M_RealIncome_Growth_6", "M_RealGDP_Growth_12", "M_RealIncome_Growth_9",
          "M_DTI_Growth_6", "M_Inflation_Growth_6", "M_Repo_Rate_9"
)
...
summary(modGLM)
evalLS(modGLM,datCredit_train,targetFld="LossRate_Real",modGLM_base)
### RESULTS: AIC: 79 664; R^2: 2.07%; RMSE: 20.70%; MAE: 11.97%
...
vars <- c("PrevDefaults", "g0_Delinq_Any_Aggr_Prop_Lag_5",
          ...
          "AgeToTerm", "Balance_Real_1", "Instalment_Real",
          "Principal_Real", "InterestRate_Nom",
          "M_DTI_Growth_12", "M_DTI_Growth_9",
          "M_RealIncome_Growth_6", "M_RealGDP_Growth_12", "M_RealIncome_Growth_9",
          "M_DTI_Growth_6", "M_Inflation_Growth_6", "M_Repo_Rate_9"
)
...
summary(modGLM_full);
evalLS(modGLM_full,datCredit_train,targetFld="LossRate_Real",modGLM_base)
### RESULTS: AIC: 69 466; R^2: 11.66; RMSE: 19.57%; MAE: 10.00%

# - Stepwise forward selection using AIC
ptm <- proc.time() # for runtime calculations (ignore)
modGLM_step <- stepwise_cpglm_both(modGLM_base, modGLM_full,datCredit_train)
proc.time() - ptm # IGNORE: elapsed runtime; 482
...
### CONCLUSION: Select variables from automated variable selection procedure:
###             [PrevDefaults]; [DefSpell_Maturity_Aggr_Mean]; [g0_Delinq_Num]
###             [g0_Delinq_Any_Aggr_Prop_Lag_5]; [DefSpell_Age]; [g0_Delinq_Any_Aggr_Prop_Lag_12];
###             [slc_past_due_amt_imputed_med]; [NewLoans_Aggr_Prop]; [M_RealIncome_Growth_6];
###             [Balance_Real_1]; [g0_Delinq_SD_5]; [ArrearsToBalance_Aggr_Prop];
###             [M_Inflation_Growth_6]; [DefaultStatus1_Aggr_Prop_Lag_2]; [DefaultStatus1_Aggr_Prop_Lag_1];
###             [g0_Delinq_Any_Aggr_Prop_Lag_9]; [InterestRate_Nom]; [M_DTI_Growth_6];
###             [AgeToTerm_Aggr_Mean]; [M_RealIncome_Growth_9]; [AgeToTerm]

### CONCLUSION: The following varaibles are insignificant:
###               [M_RealIncome_Growth_6]; [ArrearsToBalance_Aggr_Prop]
###             Refit model without these variables


# --- 6.2 Model refinements
# - Initialize variables to be tested
vars <- c("PrevDefaults", "DefSpell_Maturity_Aggr_Mean", "g0_Delinq_Num",
          "g0_Delinq_Any_Aggr_Prop_Lag_5", "DefSpell_Age", "g0_Delinq_Any_Aggr_Prop_Lag_12",
          "slc_past_due_amt_imputed_med", "NewLoans_Aggr_Prop",
          "Balance_Real_1", "g0_Delinq_SD_5",
          "M_Inflation_Growth_6", "DefaultStatus1_Aggr_Prop_Lag_2", 'DefaultStatus1_Aggr_Prop_Lag_1',
          "g0_Delinq_Any_Aggr_Prop_Lag_9", "InterestRate_Nom", "M_DTI_Growth_6",
          "AgeToTerm_Aggr_Mean", "M_RealIncome_Growth_9", "AgeToTerm"
)
...
summary(modGLM)
evalLS(modGLM,datCredit_train,targetFld="LossRate_Real",modGLM_base)
### RESULTS: AIC: 69 545; R^2: 11.57; RMSE: 19.58%; MAE: 10.02%
...
vars <- c("PrevDefaults", "DefSpell_Maturity_Aggr_Mean", "g0_Delinq_Num",
          ...
          "slc_past_due_amt_imputed_med", "NewLoans_Aggr_Prop",
          "Balance_Real_1", "g0_Delinq_SD_5",
          "DefaultStatus1_Aggr_Prop_Lag_2", 'DefaultStatus1_Aggr_Prop_Lag_1',
          "g0_Delinq_Any_Aggr_Prop_Lag_9", "InterestRate_Nom", "M_DTI_Growth_6",
          "AgeToTerm_Aggr_Mean", "M_RealIncome_Growth_9", "AgeToTerm"
)
...
summary(modGLM)
evalLS(modGLM, datCredit_train,targetFld="LossRate_Real", modGLM_base)
### RESULTS: AIC: 69 547; R^2: 11.61; RMSE: 19.58%; MAE: 10.02%
